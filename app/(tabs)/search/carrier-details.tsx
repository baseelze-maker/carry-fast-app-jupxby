...
export default function CarrierDetailsScreen() {
  ...
  // Mock carrier data - In production, fetch based on params.carrierId
  const carrier = {
    id: params.carrierId || '2',
    name: 'Sarah Johnson',
    rating: 4.9,
    reviews: 24,
    verified: true,
  ...
  // Check if user has paid the communication fee for this carrier
  const hasPaid = hasPaidCommunicationFee(carrier.id);
  ...
  const handleSubmitRequest = () => {
    ...
    if (weight > 3) {
      Alert.alert('Weight Limit Exceeded', 'This carrier can only carry up to 3 kg. Please adjust your item weight.');
      return;
    }
    ...
    Alert.alert(
      ...
      `Your request has been sent to ${carrier.name} with an offer of $${offerAmount}.\n\nItem: ${itemDescription}\nWeight: ${itemWeight} kg\n\nNext Steps:\n\n1. Wait for ${carrier.name} to accept your request (Primary Acceptance)\n\n2. Once accepted, pay $5 communication fee to unlock messaging\n\n3. Coordinate pickup details via messages\n\n4. Pay ${carrier.name} the carrying service fee (cash or card)`,
      [
        {
          text: 'OK',
          onPress: () => {
  ...
  const handleMessageCarrier = () => {
    console.log('Message button clicked. Has paid:', hasPaid, 'Carrier ID:', carrier.id);
    
    // Check if user has paid the communication fee
    if (!hasPaid) {
      Alert.alert(
        'Communication Fee Required',
        `To message ${carrier.name}, you need to pay a one-time $5 communication fee to the app.\n\nThis fee unlocks:\n• Direct messaging with ${carrier.name}\n• Pickup coordination\n• Payment arrangement for carrying service\n\nImportant: The $5 fee is paid to the app for communication access. The carrying service payment to ${carrier.name} is separate and will be arranged directly.`,
        [
          {
            text: 'Pay $5 Communication Fee',
            onPress: () => {
              console.log('Navigating to app payment for carrier:', carrier.id);
              router.push({
                pathname: '/app-payment',
                params: {
                  carrierName: carrier.name,
                  requestId: carrier.id,
                },
              });
            },
          },
    ...
    console.log('Opening chat with carrier:', carrier.id);
    router.push(`/chat/${carrier.id}`);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Carrier Details</Text>
      ...
      >
        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.profileInfo}>
            ...
            <View style={styles.ratingRow}>
              ...
              <Text style={styles.reviewsText}>({carrier.reviews} reviews)</Text>
            </View>
            <Text style={styles.memberSince}>Member since {carrier.joinedDate}</Text>
            <View style={styles.responseTimeContainer}>
              ...
              />
              <Text style={styles.responseTimeText}>Usually responds in {carrier.responseTime}</Text>
            </View>
          </View>
        </View>
          ...
          <View style={styles.paymentBanner}>
            ...
            <View style={styles.paymentBannerContent}>
              ...
              <Text style={styles.paymentBannerText}>
                Send a request first. Once the carrier accepts, pay $5 communication fee to unlock messaging.
              </Text>
            </View>
          </View>
        )}
          ...
          <View style={styles.paymentBannerSuccess}>
            ...
            <View style={styles.paymentBannerContent}>
              ...
              <Text style={styles.paymentBannerTextSuccess}>
                You can now message {carrier.name} to coordinate pickup details.
              </Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.statsCard}>
          <View style={styles.statItem}>
            <IconSymbol 
              ...
              color={colors.success} 
            />
            <Text style={styles.statNumber}>{carrier.completedTrips}</Text>
          ...
          <View style={styles.statItem}>
            <IconSymbol 
              ...
              color={colors.accent} 
            />
            <Text style={styles.statNumber}>{carrier.rating}</Text>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.detailsGrid}>
              <View style={styles.detailBox}>
                ...
                <Text style={styles.detailValue}>{carrier.date}</Text>
              </View>
              <View style={styles.detailBox}>
                <IconSymbol 
                  ios_icon_name="clock" 
                ...
                <Text style={styles.detailValue}>{carrier.time}</Text>
              </View>
              <View style={styles.detailBox}>
                <IconSymbol 
                ...
                <Text style={styles.detailValue}>{carrier.weight}</Text>
              </View>
              <View style={styles.detailBox}>
                <IconSymbol 
                ...
                <Text style={styles.detailValue}>{carrier.suggestedPrice}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <Text style={styles.descriptionText}>{carrier.description}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            {carrier.preferences.map((pref, index) => (
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            {carrier.restrictions.map((restriction, index) => (
          ...
          <View style={styles.card}>
            <View style={styles.processNotice}>
              ...
              <Text style={styles.processNoticeText}>
                You will hand over your item to the carrier at pickup. The carrier will carry it to the destination where our Centre representative will collect it.
              </Text>
            </View>
            <View style={styles.meetingPoint}>
              ...
              <View style={styles.meetingInfo}>
                <Text style={styles.meetingLabel}>Pickup Point (You → Carrier)</Text>
                <Text style={styles.meetingText}>{carrier.meetingPoints.pickup}</Text>
              </View>
            </View>
            ...
            <View style={styles.meetingPoint}>
              ...
              />
              <View style={styles.meetingInfo}>
                <Text style={styles.meetingLabel}>Handover Point (Carrier → Centre Rep)</Text>
                <Text style={styles.meetingText}>{carrier.meetingPoints.handover}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Reviews ({carrier.reviews})</Text>
            <TouchableOpacity>
            ...
            >
              ...
              <View style={styles.modalCarrierInfo}>
                <IconSymbol 
                  ...
                  color={colors.primary} 
                />
                <View style={styles.modalCarrierDetails}>
                  <Text style={styles.modalCarrierName}>{carrier.name}</Text>
                  <Text style={styles.modalCarrierRoute}>{carrier.from} → {carrier.to}</Text>
                </View>
              </View>
              ...
              <View style={styles.flowNotice}>
                ...
                <View style={styles.flowNoticeStep}>
                  ...
                  <Text style={styles.flowNoticeStepText}>Carrier accepts your request</Text>
                </View>
                <View style={styles.flowNoticeStep}>
                ...
                <View style={styles.flowNoticeStep}>
                  ...
                  <Text style={styles.flowNoticeStepText}>Message carrier to coordinate</Text>
                </View>
                <View style={styles.flowNoticeStep}>
                  <Text style={styles.flowNoticeStepNumber}>4.</Text>
                  <Text style={styles.flowNoticeStepText}>Pay carrier carrying service fee</Text>
                </View>
              </View>
              ...
              <View style={styles.priceNotice}>
                ...
                <Text style={styles.priceNoticeText}>
                  Suggested fee: {carrier.suggestedPrice} (You can offer a different amount)
                </Text>
              </View>
              ...
              <View style={styles.formGroup}>
                ...
                <Text style={styles.helperText}>
                  The carrier can accept, decline, or send a counteroffer
                </Text>
              </View>
